...
| Phase | 内容 | ゴール |
|-------|------|--------|
| 1 | 基盤構築 & 基本チャットUI | サイドバーにReactチャットが表示される | 完了 |
| 2 | 設定画面 & Gemini API接続 | 実際のAI応答がストリーミング表示される | 完了 |
| 3 | ナレッジファイル活用 | Vaultファイルを参照した回答が得られる | 未着手 |
| 4 | チャット保存 | チャットをMarkdownとして保存できる | 完了 |
| 5 | ファイル操作 | AIの指示でファイルを作成・編集できる | 完了 |
| 6 | インライン補完 | エディタ上でAI補完が動作する | 未着手 |
| 7 | 仕上げ | セッション永続化、パフォーマンス最適化 | 一部完了 |
